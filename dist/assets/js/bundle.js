...
module.exports = {
  init: function () {
    $('.accordion .title').on('click', function () {
      $(this).closest('.acc-item').find('.content').slideToggle('3000', function () {// Animation complete.
      });
    });
  }
};
...
module.exports = {
  init: function () {
    ...
    if (header.length > 0) {
      ...
      var padding = 45; // Link is on the same page
...
},{"animejs":1,"jquery":2}],8:[function(require,module,exports){
      ...
      boxes[i].onmouseenter = function (e) {
        ...
        switch (edge) {
          case 'top':
            ...
            overlay.style.left = '0%'; //tween overlay from the right
...
module.exports = {
  init: function () {
    ...
    console.log(vh + 'px'); // Then we set the value in the --vh custom property to the root of the document
...
module.exports = {
  init: function () {// console.log('Slider is loaded');
  }
};

},{"jquery":2,"slick-slider":3}],11:[function(require,module,exports){
var $ = require('jquery');
...
accordions.init();
anchors.init();
animate.init(); // direction.init();

first.init();
slider.init();
var myLazyLoad = new LazyLoad(); // After your content has changed...

myLazyLoad.update();

},{"./modules/accordions.js":5,"./modules/anchors.js":6,"./modules/animate.js":7,"./modules/direction.js":8,"./modules/first-layout.js":9,"./modules/slider.js":10,"./modules/style-guide.js":11,"animejs":1,"jquery":2,"vanilla-lazyload":4}]},{},[12])
